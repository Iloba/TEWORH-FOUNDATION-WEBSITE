 	 	...
 	 	<div class="container-fluid">
 	 		<div class="container">
 	 			<div class="row">
	 	 			...
	 	 			<div class="col-md-4">
	 	 				<h3 class="text-success">Teworh Sports and Skills Centre</h3>
	 	 				<p>Visit Our Sports and Skills Centre and access the wide range of services we have to offer <br> <br>
	 	 					<a href="services.php" class="btn btn-danger">Visit Sports and Skills Centre</a>
	 	 				</p>
	 	 			</div>
 	 			</div>
 	 		</div>
